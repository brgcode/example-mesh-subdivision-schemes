...
trimesh.transform(Translation.from_vector(Point(0.5, 0.5, 0.5) - Point(0, 0, 0)))
...
viewer.add(tri, show_faces=False, show_edges=True)
viewer.add(corner, facecolor=(0.2, 0.2, 0.2), linecolor=(0.0, 0.0, 0.0), opacity=0.3)
